          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 group">
              <img
                src="/logo_emblem.png"
                alt="SaajSakhee Logo"
                className="h-9 w-9 object-contain rounded-full border border-gold-500/20 shadow-md group-hover:scale-105 transition-all duration-300"
              />
              <h2 className="text-xl font-bold tracking-[0.2em] font-luxury text-gradient-gold">
                SAAJSAKHEE
              </h2>
            </Link>
