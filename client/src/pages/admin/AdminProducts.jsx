                        ...
                        {product.sizes?.length > 0 ? (
                          <>
                            {product.sizes.map((s, i) => {
                              ...
                              const chipClass = stockLevel === "out" ? "bg-red-500/10 text-red-400 border border-red-500/20" : stockLevel === "low" ? "bg-gold-500/10 text-gold-400 border border-gold-500/20" : "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20";
                              return (
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div className="relative">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`w-10 h-5 rounded-full transition-colors ${form.isFeatured ? "bg-gold-500" : "bg-surface-600"}`}>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    type="button"
                    onClick={addSize}
                    className="px-3 py-2 rounded-xl bg-gradient-to-r from-gold-300 to-gold-500 text-obsidian-950 font-bold hover:brightness-110 transition-colors text-sm"
                  >
                    Add
                  </button>
                </div>
