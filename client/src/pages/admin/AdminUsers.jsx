    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <User className="mx-auto h-12 w-12 text-text-muted/40 mb-4" />
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-surface-700 flex items-center justify-center text-xs font-bold text-text-secondary uppercase shrink-0">
                        ...
                        <div>
                          <p className="text-sm font-medium text-text-primary truncate max-w-[150px]">
                            {user.username || "N/A"}
                            {user.isDisabled && (
                              <span className="ml-2 text-[10px] text-text-muted">(disabled)</span>
                            )}
                          </p>
                        </div>
                      </div>
                    ...
                    <td className="px-4 py-3">
                      <span className="text-sm text-text-secondary truncate max-w-[180px] block">
                        {user.email || "--"}
                      </span>
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        {user.role === "admin" ? (
                          ...
                          <span className="text-xs text-text-muted capitalize">{user.role || "user"}</span>
                        )}
                      </div>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="p-1.5 text-text-muted hover:text-gold-500 hover:bg-surface-600 rounded-lg transition-colors disabled:opacity-50"
